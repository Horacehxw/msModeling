...
@patch('experimental.optimizer.interfaces.custom_process.CustomProcess.kill_residual_process')
@patch('experimental.optimizer.interfaces.custom_process.CustomProcess.before_run')
@patch('experimental.optimizer.interfaces.custom_process.subprocess.Popen')
