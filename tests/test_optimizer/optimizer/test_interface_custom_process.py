...
from src.optimize.experimental.optimizer.interfaces.custom_process import CustomProcess, tempfile, os
...
@patch("src.optimize.experimental.optimizer.interfaces.custom_process.kill_process")
...
@patch('src.optimize.experimental.optimizer.interfaces.custom_process.CustomProcess.kill_residual_process')
@patch('src.optimize.experimental.optimizer.interfaces.custom_process.CustomProcess.before_run')
@patch('src.optimize.experimental.optimizer.interfaces.custom_process.subprocess.Popen')
