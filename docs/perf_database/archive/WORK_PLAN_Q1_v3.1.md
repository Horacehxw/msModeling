...
**璁捐鏂囨。**: `OPERATOR_PERF_DATABASE_DESIGN_zh_v1.3.1.md`锛堝悓鐩綍锛?
...
**鍙樻洿鏃ュ織**: `CHANGELOG_20260312.md`锛堝悓鐩綍锛?
...
| B2 | `_lookup_composite()`锛歮atmul_all_reduce 鍒嗚В + MLA 鍒嗚В妗嗘灦 | 3.13 鈫?馃攧 杩涜涓?| MC2 compute+comm sum 鍒濈瀹屾垚锛汳oE/MLA spec 璧疯崏涓?|
...
| C4 | Qwen3 Decode 鍦烘櫙鏄犲皠琛ュ厖 + 楠岃瘉 | 3.12 鈫?馃攧 杩涜涓?| shape 涓嶅尮閰嶉棶棰樺緟瑙ｅ喅 |
...
| D2 | `_lookup_attention()` 瀹炵幇 | 3.10 鈫?馃攧 杩涜涓?| 鏀拺 microbench 闂涓?|
| D3 | InterpolatingDataSource 鍩虹鐗?| 3.12 鈫?馃攧 杩涜涓?| |
