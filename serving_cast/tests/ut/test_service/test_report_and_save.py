...
from serving_cast.service.report_and_save import _get_agg_table_buf, Summary
...
class TestSummary(unittest.TestCase):
    def setUp(self):
        ...
        self.summary = Summary(self.data_config)

    def test_initialization(self):
        """Test Summary initialization"""
        self.assertIsNone(self.summary._stop_flag)
    ...
    def test_set_stop_flag_memory_negative(self):
        ...
        self.summary.set_stop_flag(memory_left=-1, tpot=10.0, ttft=100.0)
        self.assertTrue(self.summary.check_stop_flag())

    def test_set_stop_flag_tpot_exceeds_limit(self):
        """Test set_stop_flag when tpot exceeds limit"""
        self.summary.set_stop_flag(
    ...
    def test_set_stop_flag_all_within_limits(self):
        ...
        self.assertFalse(self.summary.check_stop_flag())

    def test_check_stop_flag_initial_state(self):
        """Test check_stop_flag initial state (should be None which evaluates to False)"""
        # Initially _stop_flag is None, which should evaluate to False
        flag = self.summary.check_stop_flag()
        self.assertIsNone(flag)

    @patch("serving_cast.service.report_and_save.logger")
    ...
    @patch("serving_cast.service.report_and_save.logger")
    @patch("serving_cast.service.report_and_save._get_agg_table_buf")
...
class TestGetAggTableBuf(unittest.TestCase):
    def test_get_agg_table_buf_with_different_parallel_values(self):
        ...
        self.assertIn("Top 2 Aggregation Configurations:", result)
